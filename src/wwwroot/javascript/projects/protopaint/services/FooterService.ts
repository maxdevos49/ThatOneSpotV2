...
import { Observable, Subject, fromProperty } from "../../../util/Observable/observable.js";
import { IDataPart, IDataSource, SelectMode, SourceMode, DataSourceCollection } from "../../../util/ActionCommander/services/DataSourceCollection.js";
...
export class FooterService {
    ...
    private addElement(element: HTMLElement) {
        ...
        document.querySelector("div.footer>div#right")?.appendChild(element);
    }
