import { IActionExtension } from "../../../util/ActionCommander/interfaces/IActionExtension.js";
...
export class InteractionLayer implements IActionExtension {
    ...
    constructor(actionCommander: IActionCommander, interactionModeService: InteractionModeService, canvasService: CanvasService, footer: FooterService, mouse: MouseService) {
